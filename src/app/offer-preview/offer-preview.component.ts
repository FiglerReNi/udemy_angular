...
// Ennek a komponensnek csak akkor kellene megjelennie, ha a felhasználó legörget a lap aljára és onnantól kellene
// indulnia a számlálónak, ezt a lazy-loading deferrable views változatával csináljuk meg
